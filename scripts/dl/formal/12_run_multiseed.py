...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        nargs="*",
        default=[
            "configs/train_vit_seg_baseline_v1_seed42.yaml",
            "configs/train_vit_seg_baseline_v1_seed3407.yaml",
            "configs/train_vit_seg_baseline_v1_seed2026.yaml",
        ],
...
def main() -> None:
    ...
    train_script = script_dir / "10_train_vit_seg_formal.py"
    eval_script = script_dir / "11_eval_vit_seg_formal.py"
