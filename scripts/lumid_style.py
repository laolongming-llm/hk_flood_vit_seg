...
LUM_ID_STYLE: Final[list[tuple[int, str, str, str, tuple[int, int, int]]]] = [
    ...
    (7, "fish_pond_land", "鱼塘用地", "#4DBBD5", (77, 187, 213)),
    (8, "water_body", "水体", "#1F78B4", (31, 120, 180)),
    (9, "mountainous_land", "山地/自然地", "#33A02C", (51, 160, 44)),
    (10, "mangrove_land", "红树林", "#8C6D31", (140, 109, 49)),
