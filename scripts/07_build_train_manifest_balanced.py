...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--num-classes", type=int, default=10, help="类别数量（默认 10）")
    parser.add_argument(
        "--method",
    ...
    parser.add_argument("--rare-class-ids", default="6,7,10", help="需要额外增强关注的类别 ID（逗号分隔）")
...
def main() -> None:
    ...
    repeat_stats = (
        train_with_meta[
            ...
            + [c for c in ["class_6", "class_7", "class_10"] if c in train_with_meta.columns]
        ]
